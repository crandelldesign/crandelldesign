<nav class="navbar">
    ...
    <div class="navbar-links">
        <ul class="nav navbar-nav navbar-right">
            <li><a href="{{url('/portfolio')}}" data-toggle="collapse" data-target="#main-menu-collapse">Portfolio</a></li>
...
<nav class="navbar navbar-fixed-top" id="main-menu">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand animsition-link" href="{{url('/')}}">@include('layouts.logo')</a>
        </div>
