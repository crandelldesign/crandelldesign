    ...
    <!--<div class="modal-dialog modal-lg">-->
        <div class="modal-content">
            <div class="modal-header">
                ...
                @endif
                    Christ Lutheran Church of Waterford
                @if(isset($fullPage))
                    </h1>
                @else
                    </h3>
                @endif
                Waterford, MI | <a href="http://www.christwaterford.org" target="_blank">View Website <i class="fa fa-angle-right" aria-hidden="true"></i></a>
            </div>
