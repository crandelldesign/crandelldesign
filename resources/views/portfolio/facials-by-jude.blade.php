    ...
    <!--<div class="modal-dialog modal-lg">-->
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <p class="lead">Crandell Design redsigned the website for Facials by Jude, located in Oxford, MI. It now works on multiple devces and features Jude's personal style.</p>
                    </div>
                </div>
