...
<p class="city-view-more">Oxford, MI | <a href="http://www.facialsbyjude.com" target="_blank">View Website <i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
...
<div class="row">
    <div class="col-lg-8">
        <p class="lead">With the latest redesign, the website is configured to work on multiple devices and features Jude's personal style.</p>
    </div>
</div>

<div class="row">
    <div class="col-sm-7 col-lg-8 margin-bottom-20">
