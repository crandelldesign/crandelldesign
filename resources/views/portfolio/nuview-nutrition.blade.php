...
<p class="city-view-more">Clarkston, MI | <a href="https://www.nuviewnutrition.com" target="_blank">View Website <i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
...
<div class="row">
    <div class="col-md-5">
        <p class="lead">The logo and website created for Nuview Nutrition displays a clean look and bold colors.</p>
    </div>
