...
<p class="city-view-more">Vicksburg, MI | <a href="https://www.vicksburgfamilydentistry.com" target="_blank">View Website <i class="fa fa-angle-right" aria-hidden="true"></i></a></p>

<hr>

<div class="text-center margin-bottom-20"><img srcset="{{url('/img/portfolio/vicksburg-family-dentistry/vicksburg-family-dentistry-banner@2x.jpg')}} 2x" src="{{url('/img/portfolio/vicksburg-family-dentistry/vicksburg-family-dentistry-banner.jpg')}}" alt="Responsive Display of the Vicksburg Family Dentistry Website" class="img-responsive center-block portfolio-img" /></div>
